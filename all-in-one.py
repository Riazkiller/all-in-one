...
try:
    ...
    time.sleep(1)
    os.system('python2 all-in-one.py')
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            print "\033[1;91mWrong!,\033[1;92mjoin our watsapp to get the correct password"
            os.system('xdg-open https://wa.me/+923188214452')

    else:
        print "\033[0;37;41mWrong!,\033[0;37;41mjoin our watsapp to get the correct username"
	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				print '\x1b[1;92m[RIAZ Hacked]\x1b[0m ' + k + c + user + ' | ' + pass1+'\n'+"\n"
